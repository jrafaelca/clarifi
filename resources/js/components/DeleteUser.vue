                ...
                <DialogContent>
                    ...
                    >
                        <DialogHeader class="space-y-3">
                            <DialogTitle
                                >Estas seguro de que quieres eliminar tu
                                cuenta?</DialogTitle
                            >
                            <DialogDescription>
                                Cuando elimines tu cuenta, todos sus recursos y
                                datos tambien se eliminaran de forma
                                permanente. Ingresa tu contrasena para
